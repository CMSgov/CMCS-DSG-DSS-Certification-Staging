...
## Documentation and Reporting {#documentation}
- The State Medicaid Agency (SMA) and vendor must provide fully detailed, results of all privacy and security evidence, including but not limited to the Security Assessment Report (SAR), penetration tests, vulnerability scans, and the Plan of Action and Milestones (POA&M). CMS will allow redaction of sensitive information (e.g., IP addresses and hostnames). However, all other information, including network architecture, is required to support the certification decision.
...
- Plan of Action and Milestones 
    ...
    - There is no mandatory required POA&M template based on SMC guidelines.  States can use industry best practice POA&M templates such as the FedRAMP POA&M template (see below Reference section). 
...
Answer: CMS will allow redaction of sensitive information (e.g., IP addresses and hostnames). However, all other information, including network architecture, is required to support the certification decision. Having complete and unredacted artifacts is necessary to demonstrate compliance and the effectiveness of security and privacy controls.  Redactions can lead to a loss of important context, making it difficult for CMS to fully understand the security and privacy measures in place.  Redactions can compromise assessment of the security and privacy measures’ effectiveness. 
...
- Plan of Action & Milestones (POA&M) – states must update POA&Ms throughout DDI and M&O and address all vulnerabilities, including at minimum, those from the SCA, penetration testing, vulnerability scans, and DR findings.  CMS recommends using the FedRAMP POA&M template. 
