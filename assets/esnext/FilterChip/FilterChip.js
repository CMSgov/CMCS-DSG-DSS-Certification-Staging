...
export var FilterChip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(FilterChip, [{
    ...
    value: function render() {
      ...
      var buttonClassNames = classNames('ds-c-filter-chip__button', size && size === 'big' ? 'ds-c-filter-chip__button--big' : '', className);
      var iconContainerClassNames = classNames('ds-c-filter-chip__clear-icon-container', useAlternateIcon ? 'ds-c-filter-chip__clear-icon-alternate-container' : '');
      ...
      }, useAlternateIcon ? /*#__PURE__*/React.createElement(ClearIconAlternate, null) : /*#__PURE__*/React.createElement(ClearIcon, null))));
    }
  }]);
