...
export var FormControl = /*#__PURE__*/function (_React$Component) {
  ...
  function FormControl(props) {
    ...
    _this.id = props.id || uniqueId('field_');
  ...
  _createClass(FormControl, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          errorPlacement = _this$props$errorPlac === void 0 ? errorPlacementDefault() : _this$props$errorPlac,
      ...
      var renderBottomError = bottomError ? /*#__PURE__*/React.createElement(InlineError, {
        id: this.errorId,
        inversed: inversed,
      ...
      var renderHiddenError = isFieldset && bottomError ? /*#__PURE__*/React.createElement("div", {
...
_defineProperty(FormControl, "propTypes", {
  ...
  /**
     ...
     */
  component: _pt.oneOf(['div', 'fieldset']).isRequired,
  ...
  /**
     ...
     */
  labelComponent: _pt.oneOf(['label', 'legend']).isRequired,
...
export var FormControlPropKeys = ['className', 'component', 'errorId', 'errorMessage', 'errorMessageClassName', 'errorPlacement', 'focusTrigger', 'hint', 'id', 'inputRef', 'inversed', 'label', 'labelClassName', 'labelComponent', 'labelId', 'requirementLabel', 'render'];
