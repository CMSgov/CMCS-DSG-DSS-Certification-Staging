...
export var Spinner = function Spinner(props) {
  var className = classNames('ds-c-spinner', props.size && "ds-c-spinner--".concat(props.size), props.inversed && 'ds-u-fill--background-inverse ds-u-color--base-inverse', props.filled && 'ds-c-spinner--filled', props.className);
