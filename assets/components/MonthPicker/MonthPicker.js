...
var monthNumbers = function () {
  ...
  for (var m = 1; m <= _getMonthNames.NUM_MONTHS; m++) {
    months.push(m);
  }
...
var MonthPicker = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function MonthPicker(props) {
    ...
    _this.months = (0, _getMonthNames.getMonthNames)(props.locale);
    _this.monthsLong = (0, _getMonthNames.getMonthNames)(props.locale, false);
  ...
  _createClass(MonthPicker, [{
    ...
    value: function render() {
      ...
      var selectedMonths = this.selectedMonths();
      var disabledMonths = this.disabledMonths();
      var selectAllPressed = selectedMonths.length === _getMonthNames.NUM_MONTHS - disabledMonths.length;
      ...
      var containerClassName = (0, _classnames.default)('ds-c-month-picker', this.props.className);
...
MonthPicker.propTypes = {
   ...
   */
  buttonVariation: _propTypes.default.string,
   ...
   */
  disabledMonths: _propTypes.default.arrayOf(_propTypes.default.number),
   ...
   */
  selectedMonths: _propTypes.default.arrayOf(_propTypes.default.number),
   ...
   */
  defaultSelectedMonths: _propTypes.default.arrayOf(_propTypes.default.number),
