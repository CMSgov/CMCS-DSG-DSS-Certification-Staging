...
export declare type DateInputDayDefaultValue = string | number;
export declare type DateInputDayValue = string | number;
export declare type DateInputMonthDefaultValue = string | number;
export declare type DateInputMonthValue = string | number;
export declare type DateInputYearDefaultValue = string | number;
export declare type DateInputYearValue = string | number;
...
export declare class DateInput extends React.PureComponent<DateInputProps> {
