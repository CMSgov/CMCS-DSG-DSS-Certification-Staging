...
{% assign cms = "MES Outcomes - CMS-Required Eligibility and Enrollment" %}
...
Please send examples from your state that you'd like to share to <MES.Certification@cms.hhs.gov>. Our team will collect and share the best examples.

{% assign states = "MES Outcomes - State-Specific Eligibility and Enrollment" %}
