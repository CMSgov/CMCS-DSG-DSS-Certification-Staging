{% assign csv = "MES Outcomes - Claims Processing" %}

# Claims Processing

#### How this system supports the Medicaid Program

Claims processing systems cover the ingestion and validation of claims against
rules. These systems may also generate reports to support Federal reporting
requirements.
